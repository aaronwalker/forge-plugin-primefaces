 ...
 * @author <a href="mailto:git@ronald.vankuijk.net">Ronald van Kuijk</a>
 */
@Alias("primefaces")
@RequiresFacet({ DependencyFacet.class, PersistenceFacet.class, CDIFacet.class, FacesFacet.class, PrimefacesFacet.class })
public class PrimefacesScaffold extends BaseFacet implements ScaffoldProvider
{
   ...
   private static final String BACKING_BEAN_TEMPLATE = "org/primefaces/scaffold/BackingBean.jv";
   private static final String VIEW_TEMPLATE = "org/primefaces/scaffold/view.xhtml";
   private static final String CREATE_TEMPLATE = "org/primegaces/scaffold/create.xhtml";
   private static final String LIST_TEMPLATE = "org/primefaces/scaffold/list.xhtml";
   ...
   @Inject
   public PrimefacesScaffold(final ShellPrompt prompt, final ShellPrintWriter writer, final TemplateCompiler compiler,
   ...
   public List<Resource<?>> generateFromEntity(final JavaClass entity, final boolean overwrite)
   {
      ...
      try
      {
         ...
         context.put("entity", entity);
         context.put("entityName", entity.getName().toLowerCase());
         ...
         result.add(ScaffoldUtil.createOrOverwrite(prompt, web.getWebResource("scaffold/" + type + "/create.xhtml"),
                  createTemplate.render(context), overwrite));
   ...
   {
      JavaClass util = JavaParser.parse(JavaClass.class,
               getClass().getResourceAsStream("/org/primefaces/persistence/PaginationHelper.jv"));
      JavaSourceFacet java = project.getFacet(JavaSourceFacet.class);
   ...
   public boolean isInstalled()
   {
      ...
      return project.getFacet(PrimefacesFacet.class).isInstalled() && df.hasDependency(seamPersist)
   ...
   public List<Resource<?>> generateIndex(final boolean overwrite)
   {
      ...
      result.add(ScaffoldUtil.createOrOverwrite(prompt, web.getWebResource("index.html"),
               getClass().getResourceAsStream("/org/primefaces/templates/index.html"), overwrite));

      result.add(ScaffoldUtil.createOrOverwrite(prompt, web.getWebResource("index.xhtml"),
               getClass().getResourceAsStream("/org/primefaces/templates/index.xhtml"), overwrite));
   ...
   public List<Resource<?>> generateTemplates(final boolean overwrite)
   {
      ...
      result.add(ScaffoldUtil.createOrOverwrite(prompt, web.getWebResource("/resources/forge-template.xhtml"),
               getClass()
                        .getResourceAsStream("/org/metawidget/templates/forge-template.xhtml"), overwrite));

      result.add(ScaffoldUtil.createOrOverwrite(prompt, web.getWebResource("/resources/forge.css"), getClass()
               .getResourceAsStream("/org/metawidget/templates/forge.css"), overwrite));
